...
// TODO: Cyborg reveal effect — re-enable once /jairo-cyborg.jpg is uploaded
// (clipPath drag reveal between original photo and cyborg version).
    ...
    <section className="relative min-h-screen flex items-center px-6 md:px-12 lg:px-20 py-24">
      <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-shrink-0 flex flex-col items-center">
          <div ref={tiltRef} className="relative will-change-transform group" style={{ width: 340, height: 340 }}>
            {/* Glow */}
            ...
            <div className="absolute inset-[9px] rounded-full overflow-hidden z-[2] bg-bg3">
              <Image
                ...
                priority
              />
              {/* Hover gradient overlay — brand colors */}
              <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(79,195,247,0.55)_0%,rgba(107,142,245,0.45)_50%,rgba(139,92,246,0.55)_100%)] opacity-0 group-hover:opacity-100 mix-blend-color transition-opacity duration-500" />
            </div>
            {/* Floating dots */}
